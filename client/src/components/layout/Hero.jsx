...
const PhysicsHero = () => {
    ...
    return (
        <div className="hero_section relative min-h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
            <ParticleAnimation />
